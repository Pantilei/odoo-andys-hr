    ...
    def write(self, vals):
        ...
        if "employee_type" in vals:
            if vals["employee_type"] == "trainee":
                ...
                if self.applicant_id and self.employee_type == "trainee":
                    no_of_recruitment = self.applicant_id.job_id.no_of_recruitment - 1
                    self.applicant_id.job_id.no_of_recruitment = max(0, no_of_recruitment)
